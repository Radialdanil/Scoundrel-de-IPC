...
int robo_pula (int c1, int c2, int c3, int c4, int vida) {
    ...
    if((contador_monstro > 3 && ((float)dano_monstro*2) >= treshold)||(contador_monstro==0)) {
        roboescolha = 1;
    }
...
int robo_cartas (int c1, int c2, int c3, int c4, int vida, int arma, int armat, int rando, int e1, int e2, int ve1, int ve2) {
    int escolha = -2;
